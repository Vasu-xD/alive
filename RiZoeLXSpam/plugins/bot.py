...
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph//file/3052204181b5ef4d58a46.mp4"
  

rizoel = "✯ Awesome Bot Here ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **awesome ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "**Restarting Your Awesome Bot**.. Please Wait Until It Starts Again"
